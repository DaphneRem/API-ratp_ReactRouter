...
export default class StationChaveaux extends Component {
  ...
  render() {
    ...
    return (
      <div className={classnames('StationChaveaux', className)} {...props}>
          <div className="stationPage">
              <div className="contentPage">
                  <h1 className="nameStation"> Croix de Chaveaux</h1>
